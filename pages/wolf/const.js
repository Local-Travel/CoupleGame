...
export const roleDescMap = {
	'god': ['独立', '天黑请闭眼，狼人请睁眼，请狼人击杀目标，狼人请确认目标，狼人确认请闭眼。预言家请睁眼，请选择你要看哪一个玩家的身份，好人是这个（拇指朝上），坏人是这个（拇指朝下），ta是这个（拇指朝上或朝下），预言家确认请闭眼。女巫请睁眼，女巫你有一瓶解药，你是否需要使用？你有一瓶毒药是否需要使用？女巫确认请闭眼。猎人请睁眼，猎人请闭眼。天亮了请睁眼，昨夜死亡的玩家是（xx），昨夜是平安夜，无人死亡。'],
